        ...
        <CCard>
          ...
          <CFormGroup row>
                  <CCol md="2" className="d-flex justify-content-sm-end">
                    <CLabel htmlFor="text-input">License Name</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                ...
                <CFormGroup row>
                <CCol md="2" className="d-flex justify-content-sm-end">
                    <CLabel htmlFor="select">Select Asset</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                ...
                <CancelButton size='md' location='/views/softwares' />
