            ...
            <CCollapse show={details.includes(index)}>
              <CCardBody>
                ...
                <Route render={({ history}) => (
                  <CButton type="reset" size="sm" color="dark" className="mr-1" onClick= {() => { history.push('/views/consumables/viewmoreconsumable') }}>
                       View More
                  </CButton>
                )}/>
                ...
                <Route render={({ history}) => (
                  <CButton type="reset" size="sm" color="success" className="mr-1" onClick= {() => { history.push('/views/consumables/borrowconsumable') }}>
                       Borrow
                  </CButton>
                )}/>
